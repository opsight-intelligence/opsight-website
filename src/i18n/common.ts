...
export interface CommonCopy {
  htmlLang: string;
  ogLocale: string;
  nav: { brand: string; fraud: string; procurement: string; manufacturing: string; opsentry: string };
...
export const common: Record<Locale, CommonCopy> = {
  en: {
    htmlLang: 'en',
    ogLocale: 'en_US',
    nav: { brand: 'OPSIGHT INTELLIGENCE', fraud: 'Fraud', procurement: 'Procurement', manufacturing: 'Manufacturing', opsentry: 'OpSentry' },
  ...
  ko: {
    htmlLang: 'ko',
    ogLocale: 'ko_KR',
    nav: { brand: 'OPSIGHT INTELLIGENCE', fraud: '사기 인텔리전스', procurement: '공공조달', manufacturing: '제조', opsentry: 'OpSentry' },
    langNames: { en: 'English', ko: '한국어', tr: 'Türkçe' },
  ...
  tr: {
    htmlLang: 'tr',
    ogLocale: 'tr_TR',
    nav: { brand: 'OPSIGHT INTELLIGENCE', fraud: 'Dolandırıcılık', procurement: 'Kamu İhaleleri', manufacturing: 'Üretim', opsentry: 'OpSentry' },
    langNames: { en: 'English', ko: '한국어', tr: 'Türkçe' },
